...
public class ShipOrderVo {
    ...
    private String keywdnumber;//查询关键字为数字型的，比如金额和数量，车组，专卖证号
    private Date begintime;
    private Date endtime;
    private String paymentflagname;//结算状态名称：0未结算,10已结算 5预付款
    private String itemid;//卷烟品牌id即卷烟编码
    private String itemname;//卷烟品牌
    private BigDecimal ordercount;//订单户数
    private BigDecimal paymentcount;//在线代扣笔数
    private BigDecimal  paymentamount;//在线代扣金额
	...
	public void setPaymentflagname(String paymentflagname) {
		this.paymentflagname = paymentflagname;
	}
