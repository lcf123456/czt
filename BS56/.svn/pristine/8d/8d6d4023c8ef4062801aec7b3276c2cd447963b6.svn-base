  ...
  <body>
	...
	<div id="add-dlg" >
		<form  id="add-fm" method="post" action="" novalidate  >
			...
			<tr>
			 ...
			 <div style="WIDTH: 100%; HEIGHT:360; BACKGROUND-COLOR: transparent;  scrollbar-face-color:#c1d9f5; scrollbar-arrow-color:#ffffff; scrollbar-highlight-color:#ffffff; scrollbar-3dlight-color:#70807d; scrollbar-shadow-color:#ffffff; scrollbar-darkshadow-color:#70807d; scrollbar-track-color:#ffffff">
    ...
    <input type="hidden" name="allrows" id="allrows" class="easyui-textbox"></input> <!--保存所有行的数据 -->
	 ...
	 <div id="dlg-buttons">
		...
		<a href="#" class="easyui-linkbutton" id="btn-done" iconCls="icon-cancel" onclick="closethistab('绩效修改')">关闭</a>
	</div>
	</div>
				   ...
				   var hj  = compute("selfscore");//$('#worklist').datagrid('getRows')
					...
					$('#obid').textbox("setText",obid);
					 $('#add-fm').form('submit',{
							...
							url:baseURL+"/perform/deptmonthsum/doEdit.json?obid="+obid,
							//data: {'},
							beforeSend : function () {
								$.messager.progress({
									text : '正在新增中...',
