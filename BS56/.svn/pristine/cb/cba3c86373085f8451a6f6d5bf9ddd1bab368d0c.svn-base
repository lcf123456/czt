...
<script type="text/javascript" src="<spring:url value="/js/jsp/wms/movefromsytofj.js"/>"></script>
  <head>
  ...
  <body>
	...
	<div id="add-dlg" class="easyui-dialog" style="width:960px;height:420px;padding:5px 10px;align:center;"
		...
		<form  id="add-fm" method="post" action="" novalidate  >
			...
			<div id="seconddiv">
			<tr><td ><font color="blue">散烟区待移库卷烟信息</font></td></tr>
			<tr>
	    	<td >
		  	 <table width="100%" border="0" cellpadding="2" cellspacing="2" >
		  	  <tr>
		  		 	<td width="5%" height="20" align="left" nowrap>卷烟编码：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="cigarettecode_firstok" id="cigarettecode_firstok" class="easyui-textbox" style="width:160px" readonly>
		           	</td>
		           	<td width="5%"  height="20" align="left" nowrap>卷烟名称：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="cigarettename_firstok" id="cigarettename_firstok" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>  
		           <td width="5%"  height="20" align="left" nowrap>件条比率：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="jtsize_firstok" id="jtsize_firstok" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>
		           	<td width="5%" height="20" align="left" nowrap>移库数量：</td>
		           	<td width="5%" height="20" align="left" nowrap>
		                <input name="qtynew_firstok" id="qtynew_firstok" class="easyui-numberbox" style="width:80px" data-options="validType:'length[1,10]'"><strong><font color="red" >*</font></strong>(条)
		           	</td>
	           </tr>
		 	 </table>
		     </td>
				...
				<tr><td color="blue"><font color="blue">分拣区待接收卷烟信息</font></td></tr>
				<tr>
	    	<td >
		  	 <table width="100%" border="0" cellpadding="2" cellspacing="2" >
		  	  <tr>
