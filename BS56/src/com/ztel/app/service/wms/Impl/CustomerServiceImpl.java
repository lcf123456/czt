...
public class CustomerServiceImpl implements CustomerService {
	...
	public CustomerServiceImpl() {
		...
		sortKeyMapping.put("addressseq", "addressseq");
	}
	...
	public List<CustomerVo> getCustomerseqPageList(Pagination<?> page) {
		// TODO Auto-generated method stub
		//page.sortKeyToColumn(sortKeyMapping);
		List<CustomerVo> custList = customerVoMapper.getCustomerseqPageList(page);
		return custList;
	}
	
	public int updatecustomerseqByPrimarykey(CustomerVo customerVo){
		return customerVoMapper.updateByseqPrimaryKeySelective(customerVo);
	}
