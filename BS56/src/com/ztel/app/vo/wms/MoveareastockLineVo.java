...
public class MoveareastockLineVo {
    /**
     * null
     */
    ...
    /**
     * 目标区域通道编号(分拣区或重力式货架记录用)
     */
    private String targettroughnum;
     ...
     * @return 目标区域通道号
     */
	public String getTargettroughnum() {
		return targettroughnum;
	}

	/**
	 * @param targettroughnum 目标区域通道号
	 */
	public void setTargettroughnum(String targettroughnum) {
		this.targettroughnum = targettroughnum;
	}
