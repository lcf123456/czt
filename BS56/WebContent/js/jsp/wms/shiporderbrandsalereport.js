...
jQuery(function($){
	...
	$('#dataTabel').datagrid({
		...
		nowrap:true,
		//货主默认为长沙11430101
		url:baseURL+"/wms/shiporder/getShiporderBrandSaleReport.json", //数据来源
...
//		pagination:true, //显示分页
		...
		columns:[[
			...
			{field:'customername',title:'零售户',width:$(this).width()*0.1},
			{field:'itemname',title:'品牌',width:$(this).width()*0.1},
			{field:'totalqty',title:'销售数量(条)',width:$(this).width()*0.1}
		]],
		toolbar:'#toolbar',
