...
jQuery(function($){
	...
	$('#dataTabel').datagrid({
		...
		nowrap:false,
		//货主默认为长沙11430101
		url:baseURL+"/wms/shiporder/getShiporderPageList.json", //数据来源
		...
		columns:[[
			...
			{field:'customerId',title:'专卖证号',width:$(this).width()*0.15},
			{field:'customername',title:'店名',width:$(this).width()*0.3},
			{field:'totalqty',title:'订单量(条)',width:$(this).width()*0.08,sortable:true},
			{field:'totalamount',title:'订单金额',width:$(this).width()*0.08,sortable:true},
			{field:'orderdatestr',title:'订单日期',width:$(this).width()*0.1},
			{field:'realaddresscontact',title:'联系人',width:$(this).width()*0.1},
			{field:'routecode',title:'送货车组',width:$(this).width()*0.1,sortable:true},
			{field:'paymentflagname',title:'结算状态',width:$(this).width()*0.1}
