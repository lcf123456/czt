...
<script type="text/javascript" src="<spring:url value="/js/jsp/perform/transverseAssessLeader.js"/>"></script>
  <head>
  ...
  <body>
	...
	<input type="hidden" name="datetype" id="datetype" value="10"></input>
		...
		<a href="#" id="lineBtn" class="easyui-linkbutton" iconCls="icon-mylorry" plain="true" onclick="editseq()">考核</a>
