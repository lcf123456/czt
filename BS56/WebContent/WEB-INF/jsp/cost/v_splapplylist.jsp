  ...
  <body>
	...
	<form id="queryForm" style="margin:10;">
		...
		<a href="#" id="viewBtn" class="easyui-linkbutton" iconCls="icon-view" plain="true" onclick="viewD()">查看</a>
			...
			<input class="easyui-textbox" id="keyword" name="keyword"  data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchData();},prompt:'请输入申请人、审核人、部门...'" style="width:220px;height:24px;">
