...
<script type="text/javascript">
	var creatername="${userVo.username}";
	var createrid="${userVo.id}";
	var dangerctype="${typeinfoVo.ctype}";
	var dangertype="${typeinfoVo.id}";
</script>
  </head>
  ...
  <body>
	...
	<!-- 新增对话框 -->
	<div id="add-dlg" class="easyui-dialog" style="width:400px;height:300px;padding:5px 10px;align:center;"
    ...
    <td >
	  ...
	  <table width="100%" border="0" cellpadding="2" cellspacing="2" >
           ...
           <td width="14%" height="20" align="left" nowrap>
            ...
            <td width="14%" height="20" align="left" colspan="2" nowrap>
                   <input name="dangercontent" id="dangercontent" class="easyui-textbox"  data-options="multiline:true,validType:'length[1,200]'" maxlength="200"  style="width:200px" >
            </td>  
	...
	<div id="edit-dlg" class="easyui-dialog" style="width:400px;height:300px;padding:10px 20px;align:center;"  data-options="modal:true,draggable:false"
		...
		<form id="edit-fm" method="post" action="" novalidate  >
            ...
            <tr>
              <td> <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="">
              <tr><td colspan="4"  class="style2"><font color="blue">修改隐患记录信息</font></td></tr>
               </table></td>
    ...
    <td >
	 <table width="90%" border="0" cellpadding="2" cellspacing="2" class="">
           ...
           <td width="5%"  height="20" align="left" nowrap>隐患类别：</td>
           <td width="14%" height="20" align="left" nowrap>
                   <input name="dangertype" id="ctype1" class="easyui-combobox" style="width:150px" data-options="" />
                    <!--   valueField : 'id',
	    	       textField : 'ctype',
