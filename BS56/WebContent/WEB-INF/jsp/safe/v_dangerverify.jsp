...
<script type="text/javascript" src="<spring:url value="/js/jsp/safe/dangerverify.js"/>"></script>
  ...
  <body>
	...
	<div id="handle-dlg" class="easyui-dialog"
		style="width: 650px; height: 480px; padding: 10px 20px; align: center;"
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2"
					...
					<tr align="center">
						...
						<td width="14%" height="20" align="left" nowrap><input
							...
							value="${userVo.username}" style="width: 150px" data-options="">
						</td>
					</tr>
					<tr align="center">
					...
					<tr align="center">
						...
						<td width="14%" height="20" align="left" nowrap><input
							...
							maxlength="200" style="width: 200px" readonly></td>
					</tr>
						<tr align="center" id="testTr">
							<td width="5%" height="20" align="left" nowrap>整改部门：</td>
							<td width="14%" height="20" align="left" nowrap><input
								name="deptname" id="deptname" class="easyui-combobox"
								style="width: 150px;" data-options=""></td>
							<td width="5%" height="20" align="left" nowrap>检查时间：</td>
							<td width="14%" height="20" align="left" nowrap><input
								name="verifydate" id="verifydate" class="easyui-datebox"
								style="width: 150px" data-options=""></td>
						</tr>
						<tr align="center" id="testTro">
							<td width="5%" height="20" align="left" nowrap>检查人员：</td>
							<td width="14%" height="20" align="left" nowrap><input
								name="checkid" id="checkid" class="easyui-validatebox tb"
								style="width: 150px" data-options=""> <a href="#"
								class="easyui-linkbutton" onclick="openUser()">选择人员</a></td>
						</tr>
						<tr align="center" id="testTrt">
							<td width="5%" height="20" align="left" nowrap>整改项目要求及期限：</td>
							<td width="14%" height="20" align="left" nowrap><input
								name="demands" id="demands" class="easyui-textbox"
								data-options="multiline:true,validType:'length[1,200]'"
								maxlength="200" style="width: 200px"></td>
