  ...
  <body>
	...
	<form id="queryForm" style="margin:10;">
		...
		风险等级：<input  name="levelid" id="levelid" class="easyui-combobox" style="width:100px;" data-option='' >
			...
			<input class="easyui-textbox"  name="hazards"  data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchHazardsStat();},prompt:'请输入危险源...'" style="width:350px;height:24px;">
