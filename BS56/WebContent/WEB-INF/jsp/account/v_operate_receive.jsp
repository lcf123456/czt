...
<script type="text/javascript" src="<spring:url value="/js/jsp/account/operate_receive.js"/>"></script>
  </head>
  <body>
	...
	<form id="queryForm" style="margin:10;">
		<div style="margin-bottom:5px">
			<a href="#"  id="impBtn" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="doReceive()">散烟区接收</a>
