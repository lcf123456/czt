...
<script type="text/javascript" src="<spring:url value="/js/jsp/account/operate_audit.js"/>"></script>
  </head>
  <body>
	...
	<form id="queryForm" style="margin:10;">
		<div style="margin-bottom:5px">
			<a href="#"  id="refundBtn" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="doOperate('refund')">退货</a>
			<a href="#"  id="storageBtn" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="doOperate('storage')">暂存</a>
