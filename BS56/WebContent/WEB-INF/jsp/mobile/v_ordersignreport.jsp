...
<script type="text/javascript" src="<spring:url value="/js/jsp/mobile/ordersignreport.js"/>"></script>
  <head>
  ...
  <body>
	...
	<input type="hidden" name="datetype" id="datetype" value="10"></input>
		...
		签收日期：<input name="searchtime" id="searchtime" class="easyui-datebox" style="width:90px" >&nbsp;
