...
<script type="text/javascript" src="<spring:url value="/js/jsp/wms/shiporderbrandreport.js"/>"></script>
  <head>
  ...
  <body>
	...
	<input type="hidden" name="datetype" id="datetype" value="10"></input>
		...
		订单日期：<input name="orderdate" id="orderdate" class="easyui-datebox" style="width:90px" >&nbsp;
