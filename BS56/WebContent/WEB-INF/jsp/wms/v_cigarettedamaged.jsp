  ...
  <body>
	...
	<form id="queryForm" style="margin:10;">
		...
		<a href="#" id="delBtn" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deleterow()">删除</a>
			<input class="easyui-textbox" id="keyword" name="keyword"  data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchData();},prompt:'请输入入库单号、审核人...'" style="width:220px;height:24px;">
