...
<script type="text/javascript">
	var createruser="${userVo.username}";
	var createrid="${userVo.id}";
</script>
  <head>
  <script type="text/javascript">
</script>
    ...
    <td >
	  <table width="90%" border="0" cellpadding="2" cellspacing="2" class="">
           ...
           <td width="5%" height="20" align="left" nowrap>ABC编码：</td>
            ...
            <td width="14%" height="20" align="left" nowrap>
                   <input name="itemno" id="itemno" class="easyui-validatebox tb" style="width:150px"data-options="required:true,validType:'myvalidate'" ><strong><font color="red" >*</font></strong>
            </td>
            <td width="5%" height="20" align="left" nowrap>创建人：</td>
            <td width="14%" height="20" align="left" nowrap>
                   <input name="createuser" id="createuser" class="easyui-validatebox tb" value="${userVo.username}" style="width:150px" data-options="" >
            </td>
               <td width="5%" height="20" align="left" nowrap>创建日期：</td>
           <td width="14%" height="20" align="left" nowrap>
                  <input name="createtime" id="createtime" class="easyui-datebox"style="width:100px;"data-option="">
           </td>
           </tr>
              <tr align="center" >
            <td width="5%" height="20" align="left" nowrap>满盘数量：</td>
            <td width="14%" height="20" align="left" nowrap>
                <input name="fullcount" id="fullcount" class="easyui-validatebox tb" style="width:150px" data-options="" >
            </td> 
       ...
       <td width="5%" height="20" align="left" nowrap>重量：</td>
            <td width="14%" height="20" align="left" nowrap>
                <input name="weight" id="weight" class="easyui-validatebox tb" style="width:150px" data-options="" >
            </td> 
            <td width="5%" height="20" align="left" nowrap>垛型：</td>
            <td width="14%" height="20" align="left" nowrap>
                <input name="dxtype" id="dxtype" class="easyui-validatebox tb" style="width:150px" data-options="" >
            </td> 
...
<c:import url="/WEB-INF/jsp/pub/sessionPage.jsp?paramPage=Iteminfo"></c:import>
  </body>
</html>
