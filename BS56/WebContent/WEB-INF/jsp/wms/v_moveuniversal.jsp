...
<script type="text/javascript" src="<spring:url value="/js/jsp/wms/moveuniversal.js"/>"></script>
  <head>
	...
	<div id="add-dlg" class="easyui-dialog" style="width:960px;height:420px;padding:5px 10px;align:center;"
		...
		<form  id="add-fm" method="post" action="" novalidate  >
			...
			<tr>
		           	...
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="sourceareaname_new" id="sourceareaname_new"  style="width:120px" >
		           	</td>
		            <td width="5%" height="20" align="left" nowrap>目标区域：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="targetareaname_new" id="targetareaname_new"  style="width:120px" >
		           	</td>
	         </tr>
			</table>
			</td>
		  	  ...
		  	  <tr>
		           ...
		           <td width="5%"  height="20" align="left" nowrap>件条比率：</td>
		           	...
		           	<td width="5%" height="20" align="left" nowrap>
		                <input name="qtynew" id="qtynew" class="easyui-numberbox" style="width:80px" data-options="validType:'length[1,10]'"><strong><font color="red" >*</font></strong>(分拣为条数量，立库为件数量)
		           	</td>
	           </tr>
		 	 </table>
		     </td>
			...
			<div id="seconddiv" style="padding:10">
			<tr >
            <td >
                                    请输入查询： <input class="easyui-textbox"  name="keyword_through" id="keyword_through" data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchTrough();},prompt:'请输入卷烟名称或编码'" style="width:300px;height:24px;">
           </td>
           </tr>
				<tr >
				<td>
				<table width="100%" id="troughlist"><!-- 通道列表 -->
				</table>
				</td>
				</tr>
	    	<td >
		  	 <table width="100%" border="0" cellpadding="2" cellspacing="2" >
		  	  <tr>
		  		 	<td width="5%" height="20" align="left" nowrap>卷烟编码：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="cigarettecode_secondok" id="cigarettecode_secondok" class="easyui-textbox" style="width:160px" readonly>
		           	</td>
		           	<td width="5%"  height="20" align="left" nowrap>卷烟名称：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="cigarettename_secondok" id="cigarettename_secondok" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>  
		           <td width="5%"  height="20" align="left" nowrap>通道类型：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="cigarettetypename_secondok" id="cigarettetypename_secondok" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>
		           <td width="5%"  height="20" align="left" nowrap>组次：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="groupno_secondok" id="groupno_secondok" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>
	           </tr>
	           <tr>
		  		 	<td width="5%" height="20" align="left" nowrap>通道编号：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="troughnum_secondok" id="troughnum_secondok" class="easyui-textbox" style="width:160px" readonly>
		           	</td>
		           	<td width="5%"  height="20" align="left" nowrap>物理通道编号：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="machineseq_secondok" id="machineseq_secondok" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>  
		           <td width="5%"  height="20" align="left" nowrap>移库数量：</td>
		           	<td width="23%" height="20" align="left" nowrap colspan="3">
		               <input name="move_qty" id="move_qty" class="easyui-numberbox" style="width:80px" data-options="validType:'length[1,10]'"><strong><font color="red" >*</font></strong>
		               (重力式货架为件数量，分拣为条数量)
		           </td>
	           </tr>
		 	 </table>
			...
			<div id="thirddiv" style="padding:10">
			<tr><td color="blue"><font color="blue">请选择接收通道信息:</font></br></td></tr>
			<tr >
            <td >
                                    请输入查询： <input class="easyui-textbox"  name="keyword_through2" id="keyword_through2" data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchTrough2();},prompt:'请输入卷烟名称或编码'" style="width:300px;height:24px;">
           </td>
           </tr>
				<tr >
				<td>
				<table width="100%" id="troughlist2"><!-- 通道列表 -->
				</table>
				</td>
				</tr>
	    	<td >
		  	 <table width="100%" border="0" cellpadding="2" cellspacing="2" >
		  	  <tr>
		  		 	<td width="5%" height="20" align="left" nowrap>卷烟编码2：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="cigarettecode_secondok2" id="cigarettecode_secondok2" class="easyui-textbox" style="width:160px" readonly>
		           	</td>
		           	<td width="5%"  height="20" align="left" nowrap>卷烟名称：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="cigarettename_secondok2" id="cigarettename_secondok2" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>  
		           <td width="5%"  height="20" align="left" nowrap>通道类型：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="cigarettetypename_secondok2" id="cigarettetypename_secondok2" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>
		           <td width="5%"  height="20" align="left" nowrap>组次：</td>
		           	<td width="23%" height="20" align="left" nowrap>
		               <input name="groupno_secondok2" id="groupno_secondok2" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>
	           </tr>
	           <tr>
		  		 	<td width="5%" height="20" align="left" nowrap>通道编号：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="troughnum_secondok2" id="troughnum_secondok2" class="easyui-textbox" style="width:160px" readonly>
		           	</td>
		           	<td width="5%"  height="20" align="left" nowrap>物理通道编号：</td>
		           	<td width="23%" height="20" align="left" nowrap colspan="5">
		               <input name="machineseq_secondok2" id="machineseq_secondok2" value="" class="easyui-textbox" style="width:80px" readonly/>
		           </td>  
	           </tr>
		 	 </table>
		     </td>
