  ...
  <body>
	...
	<form id="queryForm" style="margin:10;">
		<div style="margin-bottom:5px">
			...
			<input class="easyui-textbox"  name="itemname"  data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchbrandinfo();},prompt:'件码/商品名称/商品编码...'" style="width:180px;height:24px;">
